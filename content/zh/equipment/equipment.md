...
<ul class="list-unstyled">
  ...
  <li class="media my-4">
    <img class="mr-3" src="vive.jpg" alt="Generic placeholder image">
    <div class="media-body">
  ...
  <li class="media">
    <img class="mr-3" src="tms.jpg" alt="Generic placeholder image">
    <div class="media-body">
  ...
  <li class="media">
    <img class="mr-3" src="eyelink.jpg" alt="Generic placeholder image">
    <div class="media-body">
  ...
  <li class="media">
    <img class="mr-3" src="mvn.jpg" alt="Generic placeholder image">
    <div class="media-body">
